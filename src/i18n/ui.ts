...
export const ui = {
  es: {
    ...
    "faq.a2":
      "Queremos que disfrutéis de la fiesta de principio a fin sin preocuporaros por el coche. Por eso, pondremos a vuestra disposición un servicio de autobús para los trayectos de ida y vuelta con dos rutas diferentes:<br/><br/><span class='material-symbols-outlined align-middle text-[1.2em] mr-1'>directions_bus</span><b>Ruta 1: Madrid Centro</b> — <a href='https://maps.app.goo.gl/kzrEffrCiCv18p969' target='_blank' class='underline hover:text-primary'>Frente al Restaurante El Brillante (Atocha)</a> — Ida: 12:30h · Vuelta: 00:10h<br/><span class='material-symbols-outlined align-middle text-[1.2em] mr-1'>directions_bus</span><b>Ruta 2: Alcorcón</b> — <a href='https://maps.app.goo.gl/uLq1j97mFJRCYQ239' target='_blank' class='underline hover:text-primary'>Puerta del Sur</a> — Ida: 12:50h · Vuelta: 00:10h<br/><br/>Podreis reservar la plaza en cuanto recibáis la invitación física a través del código QR.",
    ...
    "gifts.title": "Detalle de Regalos",
    "gifts.subtitle":
    ...
    "gifts.ibanNumber": "ES41 1583 0001 1191 9054 0744",
    "gifts.bic": "BIC / SWIFT",
    "gifts.bicNumber": "REVOESM2",
    "gifts.copy": "Copiar IBAN",
    "gifts.thanks": "¡Muchas gracias por vuestro cariño!",
  },
  en: {
    "nav.home": "Home",
    ...
    "faq.a2":
      "We want you to enjoy the party from start to finish without worrying about the car. Therefore, we will provide a shuttle bus service for the round trip with two different routes:<br/><br/><span class='material-symbols-outlined align-middle text-[1.2em] mr-1'>directions_bus</span><b>Route 1: Madrid Center</b> — <a href='https://maps.app.goo.gl/kzrEffrCiCv18p969' target='_blank' class='underline hover:text-primary'>In front of El Brillante Restaurant (Atocha)</a> — Dep: 12:30 PM · Return: 00:10 AM<br/><span class='material-symbols-outlined align-middle text-[1.2em] mr-1'>directions_bus</span><b>Route 2: Alcorcón</b> — <a href='https://maps.app.goo.gl/uLq1j97mFJRCYQ239' target='_blank' class='underline hover:text-primary'>Puerta del Sur</a> — Dep: 12:50 PM · Return: 00:10 AM<br/><br/>You can reserve yours spot as soon as you receive the physical invitation via the QR code.",
    ...
    "gifts.title": "Gift Details",
    "gifts.subtitle":
      "Your presence is our greatest gift, but if you wish to give us a gift to help us start our life together...",
    "gifts.accountHolder": "Account Holder",
    "gifts.accountHolderName": "Marina S. & Oswald R.",
    "gifts.concept": "Concept",
    "gifts.conceptText": "Gift",
    "gifts.iban": "Account Number (IBAN)",
    "gifts.ibanNumber": "ES41 1583 0001 1191 9054 0744",
    "gifts.bic": "BIC / SWIFT",
    "gifts.bicNumber": "REVOESM2",
    "gifts.copy": "Copy IBAN",
    "gifts.thanks": "Thank you so much for your love!",
  },
} as const;
